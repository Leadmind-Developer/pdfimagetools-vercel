...
const t = {
  heroTitle: "Convert PDF to Excel Online",
  heroSubtitle:
    "Quickly convert PDF files into fully editable Excel spreadsheets (.xlsx). Preserve tables, columns, and data structure — free, secure, and no signup required.",
  stepsTitle: "How It Works",
  steps: [
    "Upload your PDF file(s).",
    "Preview extracted tables and verify data accuracy.",
    "Click the convert button to generate an Excel file.",
    "Download your Excel file instantly or convert another PDF.",
  ],
  supportedTitle: "Supported Languages",
  aboutTitle: "Why Convert PDF to Excel?",
  aboutText: [
    "Extract tables and structured data from PDFs without losing formatting.",
    "Editable Excel output allows easy analysis, reporting, or sharing.",
    "No software installation needed — works directly in your browser.",
  ],
  privacyTitle: "Privacy & Security",
  privacyText: [
    "All uploaded PDFs are deleted automatically after one hour. Nothing is stored permanently.",
    "Conversion happens securely using temporary files. No login or email required.",
  ],
  faqTitle: "Frequently Asked Questions",
  faq: [
    {
      question: "Is the PDF-to-Excel converter free?",
      answer: "Yes, it’s completely free — no limits, no watermarks, no hidden fees.",
    },
    {
      question: "Can I convert multiple PDFs at once?",
      answer: "Yes, you can upload and convert multiple PDFs in one go.",
    },
    {
      question: "Will tables and formatting be preserved?",
      answer: "Yes, we preserve tables, columns, and data structure accurately.",
    },
    {
  ...
  relatedTools: ["PDF to Word", "PDF to Images", "Compress PDF", "Image to PDF", "PDF Merge"],
};
