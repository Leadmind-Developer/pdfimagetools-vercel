...
const PdfToExcelUploader = () => {
  ...
  return (
    <div className="pdf-uploader">
      <h2>Convert PDF to Excel (Batch Upload)</h2>
      ...
      {uploads.map((upload, idx) => (
        <div key={idx} className="upload-status">
          ...
          {upload.status === 'done' && upload.downloadUrl && (
            <a href={upload.downloadUrl} download={upload.name.replace('.pdf', '.xlsx')}>
...
export default PdfToExcelUploader;
